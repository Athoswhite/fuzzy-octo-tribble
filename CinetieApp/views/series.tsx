...
const Series = () => {
  ...
  const seasons = ['', 'Season 1', 'Season 2','Season 3', 'Season 4']; // Add more seasons here
      ...
      >
        <View style={styles.overlay}>
          ...
          <View style={styles.buttonContainer}>
            <TouchableOpacity style={[styles.button, styles.redBackground]} onPress={handlePlaySeries}>
